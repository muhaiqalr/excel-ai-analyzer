      ...
      <div className="bg-gray-900 border-b border-gray-800 px-4 sm:px-6 py-3 sm:py-4">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 mb-1">
            ...
            <h1 className="text-lg sm:text-xl font-bold text-white">Analysis History</h1>
          </div>
          <p className="text-xs sm:text-sm text-gray-400">
            View and manage your past AI analysis sessions
          </p>
        </div>
      </div>
        ...
        <div className="mb-4 sm:mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-900 border border-gray-700 rounded-lg pl-10 pr-4 py-2 sm:py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
            />
          </div>
        </div>
          ...
          <div className="flex items-center justify-center py-16">
            <div className="flex flex-col items-center gap-3 text-center">
              ...
              <p className="text-xs text-gray-500 max-w-xs">
                When you run an AI analysis on your Excel files, the results will
                automatically appear here.
              </p>
              <button
                onClick={() => router.push("/dashboard")}
                className="mt-2 px-4 py-2 text-xs bg-blue-600 hover:bg-blue-700 text-white rounded-lg"
              >
                Go to Dashboard
              </button>
            </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button
                      ...
                      className="flex items-center gap-1 px-2.5 py-1.5 text-xs bg-blue-600 hover:bg-blue-700 text-white rounded"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 text-gray-400 hover:text-red-400 hover:bg-gray-800 rounded disabled:opacity-50"
                    >
                      {deleting === record.id ? (
